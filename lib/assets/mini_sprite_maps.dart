    ...
    for (final entry in objects.entries) {
      ...
      switch (spriteName) {
        ...
        case 'door':
          ...
          break;
        case 'oxygen_bubbles':
          component = OxygenTank.fromMapEntry(entry: entry);
          break;
        case 'spike_ball':
